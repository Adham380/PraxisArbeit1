...
%user journey und Kernproblemen
Dadurch ist die~\gls{User Journey}, also der Weg, den ein User durchläuft, um ein Ziel zu erreichen, womöglich umständlicher als notwendig.
\newline
\newline
...
Dies sind alles Eigenschaften und Variablen, die bei der Gestaltung des Userinterfaces noch beachtet sollte.
\newline

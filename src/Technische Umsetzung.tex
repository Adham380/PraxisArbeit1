...
\newline
\newline
Um die Animation während ihrer Laufzeit zu ändern, wird ein sogenannter Reflow ~\footcite{JavaScriptAnimationsReflow} erzwungen, indem die offsetWidth Eigenschaft abgefragt wird, die Animationsdauer und -verzögerung neu gesetzt wird und der Animationsname erst entfernt und dann wieder hinzugefügt wird.
\newline
\newline
